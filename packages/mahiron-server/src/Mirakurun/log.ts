...
class LogEvent extends EventEmitter {
  ...
  debug(...msgs: any[]): void {
    this.emit('data', LogLevel.DEBUG, getLogString('debug', msgs))
  }

  info(...msgs: any[]): void {
    this.emit('data', LogLevel.INFO, getLogString('info', msgs))
  }

  warn(...msgs: any[]): void {
    this.emit('data', LogLevel.WARN, getLogString('warn', msgs))
  }

  error(...msgs: any[]): void {
    this.emit('data', LogLevel.ERROR, getLogString('error', msgs))
  }

  fatal(...msgs: any[]): void {
    this.emit('data', LogLevel.FATAL, getLogString('fatal', msgs))
  }
