...
export function getStatus(): Status {
  const ret: Status = {
    ...
    timerAccuracy: {
      ...
      m1: {
        avg:
          status.timerAccuracy.m1.reduce((a, b) => a + b) /
          status.timerAccuracy.m1.length /
          1000,
      ...
      m5: {
        avg:
          status.timerAccuracy.m5.reduce((a, b) => a + b) /
          status.timerAccuracy.m5.length /
          1000,
      ...
      m15: {
        avg:
          status.timerAccuracy.m15.reduce((a, b) => a + b) /
          status.timerAccuracy.m15.length /
          1000,
