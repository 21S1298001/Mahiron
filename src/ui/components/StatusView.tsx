  ...
  for (let i = 0; i < statusItem.length; i++) {
    ...
    statusList.push(
      <div
        ...
        className="ms-Grid-col ms-sm12 ms-xl6 ms-xxl4 ms-xxxl3"
      >
  ...
  for (let i = 0; i < services.length; i++) {
    ...
    serviceList.push(
      <div
        ...
        className="ms-Grid-col ms-sm6 ms-xl3 ms-xxl2"
      >
        <TooltipHost
          id={tooltipId}
          ...
          content={
            `#${service.id}\n` +
            `SID: 0x${service.serviceId.toString(16).toUpperCase()} (${
              service.serviceId
            })\n` +
            `NID: 0x${service.networkId.toString(16).toUpperCase()} (${
              service.networkId
            })\n` +
