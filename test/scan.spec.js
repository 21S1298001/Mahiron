...
import { generateChannelItemForChannel, generateChannelItemForService, generateChannelItems, generateScanConfig } from "../lib/Mirakurun/api/config/channels/scan.js";

describe("Mirakurun/api/config/channel/scan : generateScanConfig", () => {
    it("GR: Type only", () => {
        const config = generateScanConfig({
            type: "GR"
        });
...
describe("Mirakurun/api/config/channel/scan : generateChannelItemForService", () => {
    it("GR Regular case", () => {
        ...
        const channelItem = generateChannelItemForService(type, ch, service, setDisabledOnAdd);
...
describe("Mirakurun/api/config/channel/scan : generateChannelItemForChannel (single service)", () => {
    it("GR Regular case", () => {
        ...
        const channelItem = generateChannelItemForChannel(type, ch, services, setDisabledOnAdd);
        assert.deepStrictEqual(channelItem, {
...
describe("Mirakurun/api/config/channel/scan : generateChannelItemForChannel (multiple service)", () => {
    ...
    it("Name Summary regular case.2", () => {
        ...
        const ch = "10";
        const setDisabledOnAdd = true;
        const services = [{ name: "xxxテレビ" }, { name: "xxxテレビ１" }, { name: "xxxテレビ２" }];
        const channelItem = generateChannelItemForChannel(type, ch, services, setDisabledOnAdd);
        assert.deepStrictEqual(channelItem, {
            name: "xxxテレビ",
            type: type,
    ...
    it("Name Summary regular case.3", () => {
        ...
        const ch = "10";
        const setDisabledOnAdd = true;
        const services = [{ name: "xxxテレビ" }, { name: "xxxテレビ１" }, { name: "データ通信" }];
        const channelItem = generateChannelItemForChannel(type, ch, services, setDisabledOnAdd);
        assert.deepStrictEqual(channelItem, {
            name: "xxxテレビ",
            type: type,
    ...
    it("Name Summary regular case.4", () => {
        ...
        const ch = "10";
        const setDisabledOnAdd = true;
        const services = [{ name: "xxxテレビ" }, { name: "xxxテレビ" }, { name: "xxxテレビ" }];
        const channelItem = generateChannelItemForChannel(type, ch, services, setDisabledOnAdd);
        assert.deepStrictEqual(channelItem, {
            name: "xxxテレビ",
            type: type,
    ...
    it("Name Summary : Full text match case.3", () => {
        ...
        const ch = "10";
        const setDisabledOnAdd = true;
        const services = [{ name: "abcdefg" }, { name: "xxxxx" }, { name: "abcdefg" }];
        const channelItem = generateChannelItemForChannel(type, ch, services, setDisabledOnAdd);
        assert.deepStrictEqual(channelItem, {
            name: "abcdefg",
            type: type,
    ...
    it("Name Summary : Full text match case.4", () => {
        ...
        const ch = "10";
        const setDisabledOnAdd = true;
        const services = [{ name: "abcdefg" }, { name: "xxxxx" }, { name: "abcdefg" }, { name: "xxx" }];
        const channelItem = generateChannelItemForChannel(type, ch, services, setDisabledOnAdd);
        assert.deepStrictEqual(channelItem, {
            name: "abcdefg",
            type: type,
    ...
    it("Name Summary : Partial text match case.3", () => {
        ...
        const ch = "10";
        const setDisabledOnAdd = true;
        const services = [{ name: "abcdefg" }, { name: "xxxx" }, { name: "abcabc" }, { name: "yyy" }];
        const channelItem = generateChannelItemForChannel(type, ch, services, setDisabledOnAdd);
        assert.deepStrictEqual(channelItem, {
            name: "abc",
            type: type,
...
describe("Mirakurun/api/config/channel/scan : generateChannelItems", () => {
    it("Service mode case.1", () => {
        ...
        const channelItems = generateChannelItems(mode, type, ch, services, setDisabledOnAdd);
